...
class DataGenerator():
    ...
    def _get_data(self):
        ...
        for i, idx in enumerate(self.cursor):
            ...
            assets_states[i, :, :, 0] = np.nanmean(tmp_states[i, :, 1:, :, 0], axis=-1)
            assets_states[i, :, :, 1] = np.nanmean(tmp_states[i, :, 1:, :, 1], axis=-1)
            assets_states[i, :, :, 2] = np.nanmean(tmp_states[i, :, 1:, :, 2], axis=-1)
            ...
            assets_states[i, :, :, 3] = np.nanmean(tmp_states[i, :, 1:, :, 3], axis=-1)
            ...
            assets_states[i, :, :, 7] = np.nanmean(tmp_states[i, :, 1:, :, 7], axis=-1)
            assets_states[i, :, :, 8] = np.nanmean(tmp_states[i, :, 1:, :, 8], axis=-1)
            assets_states[i, :, :, 9] = np.nanmean(tmp_states[i, :, 1:, :, 9], axis=-1)
            assets_states[i, :, :, 10] = np.nanmean(tmp_states[i, :, 1:, :, 10], axis=-1)
            assets_states[i, :, :, 11] = np.nanmean(tmp_states[i, :, 1:, :, 11], axis=-1)
            assets_states[i, :, :, 12] = np.nanmean(tmp_states[i, :, 1:, :, 12], axis=-1)
            assets_states[i, :, :, 13] = np.nanmean(tmp_states[i, :, 1:, :, 13], axis=-1)'''
            # FIXME
